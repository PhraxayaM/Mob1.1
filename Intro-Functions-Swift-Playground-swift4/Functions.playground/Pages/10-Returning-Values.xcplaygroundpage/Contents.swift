...
degreesToRadians(degrees: halfPi)
/*:
 ...
 */
func calculateRotationForPolygon(sides numberOfSides: Int) -> Double {
    for _ in 1...numberOfSides {
        rotate(degrees: 360 / numberOfSides)
    }
    return Double(numberOfSides)
}

calculateRotationForPolygon(sides: 8)
